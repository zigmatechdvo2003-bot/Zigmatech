...
const ScCartButton = class {
    ...
    render() {
        return (h(Host, { key: 'cd0d572b879518e3f2e72139e75d4a54baf5b559', tabindex: 0, role: "button", "aria-label": wp.i18n.sprintf(wp.i18n.__('Open Cart Menu Icon with %d items.', 'surecart'), this.getItemsCount()), onKeyDown: e => {
                if ('Enter' === (e === null || e === void 0 ? void 0 : e.code) || 'Space' === (e === null || e === void 0 ? void 0 : e.code)) {
                    store.state.cart = { ...store.state.cart, open: !store.state.cart.open };
                    e.preventDefault();
                }
            } }, h("div", { key: 'c0cb1233fdf40add265db4d0f0aa0921f28b6111', class: "cart__button", part: "base" }, h("div", { key: '4a0a381b4d639e62704b691363a531e91c1d8ccf', class: "cart__content" }, (this.showEmptyCount || !!this.getItemsCount()) && (h("span", { key: '608efaf88f387271cadced0041077f4f27e13ff5', class: "cart__count", part: "count" }, this.getItemsCount())), h("div", { key: 'e370398ae5e678bb4f130bf707d820a2c3dcf95e', class: "cart__icon" }, h("slot", { key: 'd024190b50c2b48c591de22cb34514c640bc18ad' }))))));
    }
