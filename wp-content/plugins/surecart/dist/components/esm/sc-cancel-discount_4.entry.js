...
const ScSubscriptionCancel = class {
    ...
    render() {
        ...
        return (h("sc-dashboard-module", { key: 'c9e619585fa1d6ba6a9d8edd8fa0b51e6f42c1ad', heading: heading, class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, h("div", { key: '684f08b40862b6d8f9447978d6353afaf898fd64', slot: "description" }, content, h("slot", { key: '8b412d894dd053893c969b7a22980d0a7b85c705', name: "cancel-popup-content" })), h("sc-flex", { key: 'f1bf64102797647dc53c863851a792f067d6f5e8', justifyContent: "flex-start" }, h("sc-button", { key: 'aea0ed915e6bd6bf32b43634167a07ad25f4bbeb', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, cancelButtonText), h("sc-button", { key: '1b9762afd2c6318518986a530dd22d64759e7f7e', style: { color: 'var(--sc-color-gray-500' }, type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, keepButtonText)), this.busy && h("sc-block-ui", { key: '491a9bf40aa02bcd997a564b9ce050972064dd0b' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (h("div", { key: 'e14d29c69d62db386872439fbd584633769e00ab', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, h("sc-form-control", { key: 'e1c6811e413365bc6879f94efb67b80cd3b4977f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: 'd4e1446249999debfa2f923a59e96feae368a46a', part: "form-control-input", class: "form-control-input" }, h("div", { key: 'df9331c9b03ec0beca7467e5525aebdcc411e9c7', part: "base", class: {
                'textarea': true,
