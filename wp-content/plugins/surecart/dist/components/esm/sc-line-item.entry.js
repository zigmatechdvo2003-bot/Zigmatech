...
const ScLineItem = class {
    ...
    render() {
        return (h("div", { key: 'a70753f7731f83b4ab2fba64d350cdbf49eeed2c', part: "base", class: {
                'item': true,
