...
const ScBlockUi = class {
    ...
    render() {
        return (h("div", { key: '54a9ee90eba3d65c2d2d12d854d918cf7ac04969', part: "base", class: { overlay: true, transparent: this.transparent }, style: { 'z-index': this.zIndex.toString() } }, h("div", { key: '3cd0ff07b3d6c7053b12c9f1b52cf172620f4373', class: "overlay__content", part: "content" }, h("slot", { key: '073f834808d3be2f615b3c6c4e03bad15564141b', name: "spinner" }, !this.transparent && this.spinner && h("sc-spinner", { key: '12c49adfbe44f9ed92a95df469b7e95e525a7c13' })), h("slot", { key: '2edd5da92d47b1cd5508407b737985f9d53b942a' }))));
    }
};
...
const ScSpinner = class {
    ...
    render() {
        return h("span", { key: '877d3ccd83e3c0584fc01eb705fe646a5c2408e4', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
