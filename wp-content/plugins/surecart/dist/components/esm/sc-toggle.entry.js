...
const ScToggle = class {
    ...
    render() {
        return (h("div", { key: '454b588d6a7c7a32eb16997aa7cac4156293379a', part: "base", class: {
                'details': true,
            ...
            } }, h("header", { key: '7ea56144e97d7d77997d1442468f092591a08bb2', ref: el => (this.header = el), part: "header", id: "header", class: "details__header", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": "content", "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleSummaryClick(), onKeyDown: e => this.handleSummaryKeyDown(e) }, this.showControl && (h("span", { key: 'c47508a101c8f84c2c5231203dd2288b2819858d', part: "radio", class: "details__radio" }, h("svg", { key: '76a6ed8ecb0d36ef681e6fd8ce1cc44ac1dc559f', viewBox: "0 0 16 16" }, h("g", { key: 'f06e226d3c9f548d0af174e5bbcca73be84655bb', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { key: '49e514e0f1376923609f96f3295f7a05839abd99', fill: "currentColor" }, h("circle", { key: '7ef21d7f47258417206de000bf864163ef913382', cx: "8", cy: "8", r: "3.42857143" })))))), h("div", { key: 'a3ddcc47d258bae3bcaebcdca4988deb7b639c70', part: "summary", class: "details__summary" }, h("slot", { key: '19d2ea55bd022bd48ed593537431ea0df339effd', name: "summary" }, this.summary)), this.showIcon && (h("span", { key: '31d333cbb85bf42ecf28e0ebb50b95e677bf6446', part: "summary-icon", class: "details__summary-icon" }, h("slot", { key: '2e687b7b74d9bc00a0e908ac90644e9818f22035', name: "icon" }, h("sc-icon", { key: 'd2114908650e1b78a224184319dd344030c2f700', name: "chevron-right" }))))), h("div", { key: '4330ac2a2adf4026e6bb0270a219ca235b7c35d5', class: "details__body", ref: el => (this.body = el), part: "body" }, h("div", { key: 'f3915651adfaf04d31d2b366742d6f0fa3154b45', part: "content", id: "content", class: "details__content", role: "region", "aria-labelledby": "header" }, h("slot", { key: 'ce5f541173469f6b282ce8c35e673fca50c747c8' })))));
    }
