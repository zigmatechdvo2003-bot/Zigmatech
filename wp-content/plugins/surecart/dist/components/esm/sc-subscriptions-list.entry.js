...
const ScSubscriptionsList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '36c48c0ef1a9b5d21ce7ebdae1af67e02cb6184b', class: "subscriptions-list", error: this.error }, h("span", { key: '88bdd8c21611b6659c88ef6a25217716a265447f', slot: "heading" }, h("slot", { key: '289b30d05570eb0bd4bf69c9e4bb2ddb23f32657', name: "heading" }, this.heading || wp.i18n.__('Subscriptions', 'surecart'))), !!this.allLink && !!((_a = this.subscriptions) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: 'b37324c4add581f8179b9e31fa970cc68db31a47', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || 'Subscriptions') }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '8e1dfe0176782532890cc839bb98808398d7287a', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '298454fa3f541d63b9b22fef89864d54a48e08ce', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.subscriptions) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: 'bbb8e2973346ec5f2732983a040fd0f4b74e1bb7' })));
    }
