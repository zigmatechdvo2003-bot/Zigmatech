...
const ScFormControl = class {
    ...
    render() {
        return (h("div", { key: '24e43d2d6e2ba673265e023367aeb65701082390', part: "form-control", class: {
                'form-control': true,
            ...
            } }, h("label", { key: '1f115a25706725f3933321816751b859b17ee7aa', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, h("slot", { key: '653035aa670583a46d95d63420262a0fe10bec2e', name: "label" }, this.label), h("slot", { key: '53a1b86381e4a4d0ae1850af3660f1ca1191cf79', name: "label-end" }), !!this.required && (h("span", { key: '9270a60510aa7a9766387d035f780319d82c2486', "aria-hidden": "true", class: "required" }, ' ', "*")), h("sc-visually-hidden", { key: '7800575c5fd78f4482da12b4296d874a5fffa1a3' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), h("div", { key: 'c177fa0dc65c59100474674f8c2940ceaf23e10e', part: "input", class: "form-control__input" }, h("slot", { key: '183b9c2ec880dbfc6b0f04f93b0bdd42dc63939f' })), this.help && (h("div", { key: 'e8d8b2d777016f3a6ecebc338ba456714f988564', part: "help-text", id: this.helpId, class: "form-control__help-text" }, h("slot", { key: 'b0f80387affd157418d541fd3727b3ab253ef481', name: "help-text" }, this.help)))));
    }
