...
const ScSubscriptionVariationConfirm = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '4a421841b01001aaa2dd43dedd90094ec1bffcf9', heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, h("sc-card", { key: '2ce23936605fb3adf36824b720b84be1ada4ff36' }, h("sc-form", { key: '33dda8dee9d902f282bae556f27f3eabe335de32', onScSubmit: this.handleSubmit }, h("div", { key: 'b830d6118e280daa5cda4c8ea9b9bf37409946e9', class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index) => {
            var _a, _b;
        ...
        })), h("sc-button", { key: '64f6dbcba51b057f761ad1bbbe53dde1cb1ba27d', type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", h("sc-icon", { key: 'a8da70bc22713863e3d634a940d3eb592dc8745f', name: "arrow-right", slot: "suffix" })))), this.busy && h("sc-block-ui", { key: 'c345ee15f7342ebe416767c8f291af7e97489238', style: { zIndex: '9' } })));
    }
};
