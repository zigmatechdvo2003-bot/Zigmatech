...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '4eb715b5f0319a3dadfee764d1da0bfb8fabbcc5', part: "base", class: {
                'checkbox': true,
            ...
            }, htmlFor: this.inputId, onMouseDown: () => this.handleLabelMouseDown() }, h("span", { key: '526e5f492e3e76508767027d8a24c761cc2a3fb9', part: "control", class: "checkbox__control" }, this.checked ? (h("span", { part: "checked-icon", class: "checkbox__icon" }, h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(3.428571, 3.428571)" }, h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" }))))))) : (''), !this.checked && this.indeterminate ? (h("span", { part: "indeterminate-icon", class: "checkbox__icon" }, h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(2.285714, 6.857143)" }, h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" }))))))) : (''), h("input", { key: '6b77f0b4a28e43c35419f16b593820461bb6d027', id: this.inputId, ref: el => (this.input = el), type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, role: "checkbox", "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), h("span", { key: 'f6c703ec8424d6e6a4528e16e33b03725f7ce33f', part: "label", id: this.labelId, class: "checkbox__label" }, h("slot", { key: 'a8fd2a76889fdd3fff577cffef0c1f2e93a835df' }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'c400aa89456e653998a965b03f2e763e09cb1dec', hidden: this.hidden }, h("sc-form-control", { key: 'b4690849c56022025c183f21becffac8d2ffeb68', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, h("slot", { key: '12c42616bdfd7d6720ef6e1928b3d17e730900a5', name: "label-end", slot: "label-end" }), h("div", { key: '0fffaf6bc7273b4ed76c1ed57deff7d7518f26a9', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '0f5474834cda4d523fd4666ac3feaecc2c9becfe', part: "prefix", class: "input__prefix" }, h("slot", { key: '31a4bfd47440734eabae72231ec05f1b30d8d8e0', name: "prefix" })), h("slot", { key: '54ab62d1340629a1f9d2b6d659230afa5974a6f1' }, h("input", { key: 'cc7ffb08ba1b05f3c5660ecb684f4042c8bb1b13', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), h("span", { key: 'ca0a6164dd0b1587dcf64817c958dc9c0c22a7c0', part: "suffix", class: "input__suffix" }, h("slot", { key: '45face690832301b52cc3292920e461c33df46e7', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: 'd2c64a0c4778df16d1e37936059e5d48348b54f9', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '3ee1f703818f71adc990fa99e8f6111c6182a38b', name: "clear-icon" }, h("svg", { key: '406b368a9a595ad2f95426885a54a329defc9549', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '81f3db4ad15ffc9b19630415f46530aa8a8a0ebc', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: '52ed62399a365e89ef6b4d521c39a1ec2c73331c', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Fragment, { key: 'ca4df6ac90339ac9b0aa13521975b0513516de10' }, h("sc-input", { key: '49bbfb17732b6bee47a823fdd7f5eb81fc484cbd', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), h("sc-input", { key: 'c5974437d4ce93b76a36330694b0cdcd3751a7c8', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
