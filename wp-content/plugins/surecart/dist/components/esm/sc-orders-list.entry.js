...
const ScOrdersList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: 'eda10fb3c7c46b3aac2e66cafd0e059001f542c6', class: "orders-list", error: this.error }, h("span", { key: '4c7c69408da9990aceb7f1977513c6e8b88611e3', slot: "heading" }, h("slot", { key: 'a1772938f376988b8c0815e2e3279e12d876a79e', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '51f44479786eb15709205a64267dfadf6a97b08d', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '10b271d3719116e0fe30589b7ba16ceca183b7d9', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: 'ab5300419b9093b5fbc013cac2a104426c6ef856', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: '532b8dc902879f93944e6ab1177fb59a69ecdef1' })));
    }
