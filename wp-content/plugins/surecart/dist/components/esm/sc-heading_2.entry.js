...
const ScHeading = class {
    ...
    render() {
        return (h("div", { key: '73db6bc0c5365b4a627219f3380615dab67113a2', part: "base", class: {
                'heading': true,
                'heading--small': this.size === 'small',
                'heading--medium': this.size === 'medium',
                'heading--large': this.size === 'large',
            } }, h("div", { key: '43b666fd376bc607b0a723a01b463a2786e20bee', class: { heading__text: true } }, h("div", { key: '31357b86421827adabd935e9490383b28379e792', class: "heading__title", part: "title" }, h("slot", { key: '7a074805d4bdc9a7fdf64d77527f8bf60be642f9' })), h("div", { key: 'fe79e14525eeca7983d89cdffb0896eaa94a189a', class: "heading__description", part: "description" }, h("slot", { key: '2f1f707c1c7bd350fa906db545135266962a4836', name: "description" }))), h("slot", { key: '27a705a7cf52573661b9e722756de00def800cbd', name: "end" })));
    }
...
const ScOrderConfirmComponentsValidator = class {
    ...
    render() {
        return h("slot", { key: '18b78dc40ddf86f5148f4b52378e79d881dcf65a' });
    }
    get el() { return getElement(this); }
