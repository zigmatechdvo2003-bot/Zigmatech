...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b3792cb3b12f9386eb37ee52387b1450ff475b5e', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: 'da5d8e8d692d87b0e039fcfc9701008ee8e265ca', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: '3c4580346d9b4563216c97e97b9c5ca023e5659e', name: "prefix" })), index.h(Tag, { key: '59973b5493b6b0000c98020dd5046967b1dd8e93', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: '11226f11b4ebeaad2031a646305e670fb562c408' })), index.h("span", { key: '4892190042395b2539931bb374fc0e3f094f00b3', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: 'a0d2c8f0498d8488e73621b443d93c7066adeabf', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '7414fe21bf17eb171613e371985d86e7284f1023', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: 'b97d532ce1b5c89fc27feef4f33b974cfbc9dae5', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: '91bce635ab88af6c8704989bdb5464067f1d96c7', name: "chevron-right" })))));
    }
