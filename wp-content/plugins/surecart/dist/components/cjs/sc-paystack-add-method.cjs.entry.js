...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e4e7073e5a5277540a3b771fe7f3e4c602a5bd05' }, this.error && (index.h("sc-alert", { key: '045b2d9f5ed9d62da99fa93f02c191d712c54f4a', open: !!this.error, type: "danger" }, index.h("span", { key: '338d2180eacb05c3faec04c22b43863c25b3271b', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '4a49a8471f5b2ba17af999f48b0091d93b708d95', class: "sc-paystack-button-container" }, index.h("sc-alert", { key: '8110b6ea618cb7fa89e4a00fe4cf34e6818adbae', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), index.h("div", { key: 'b3b0cb4d9fb3a4578d44f9fb1f805492f935f7a3' }, index.h("sc-button", { key: 'f7d6e62241cccfef7859f61ab674e5d50f605d43', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
