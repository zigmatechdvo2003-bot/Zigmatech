...
const ScStripeAddMethod = class {
    ...
    render() {
        return (index.h("sc-form", { key: 'f5800a8da05abd1a384eea04203d3d7beee2a144', onScFormSubmit: e => this.handleSubmit(e) }, this.error && (index.h("sc-alert", { key: '5b1cb89f8953b4b35fb0bab68b324db8d50bd7ae', open: !!this.error, type: "danger" }, index.h("span", { key: '16b55c986d6f40c4275712ed1bd5826bb46c2c5a', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '4517257f5df11b7aaf1a6e916d619ec2ceea00b6', class: "loader", hidden: this.loaded }, index.h("div", { key: 'd60b10b7133d4cafa0d07afdb045bde82bd8c563', class: "loader__row" }, index.h("div", { key: '20db90affbdd060eb156c98042697e393979916c', style: { width: '50%' } }, index.h("sc-skeleton", { key: '8658c2c52fab7c9303e71a293f7eaeadf586639c', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'f743f84da6ca91eca0eb6919db44144f99641459' })), index.h("div", { key: 'a98a666900b9a8264ae1aafd8f37348ed7a46690', style: { flex: '1' } }, index.h("sc-skeleton", { key: '90e09fdec67f16dfc93804631adcc6e274fcebb6', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'fb991aafda071bfd6aee0b3a924f43761c1e37b9' })), index.h("div", { key: '2526b2b7340131a9af6cb0e2a2576bead97ae025', style: { flex: '1' } }, index.h("sc-skeleton", { key: 'f1b577ca801da4e59b5723946af723b534f6f00f', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '2912a235af00eb572d52b99759fda185864f2c03' }))), index.h("div", { key: 'ced03e4c89633c4e0118b1fa862ba1f06a7fcfec', class: "loader__details" }, index.h("sc-skeleton", { key: 'b3fc700e3acb62b380f8c1711606d61854772ec8', style: { height: '1rem' } }), index.h("sc-skeleton", { key: '5415f16a744c54e35ed29b471865d0bbc212fa4d', style: { height: '1rem', width: '30%' } }))), index.h("div", { key: '64d978438e861afc2634dea777c9cb33918fb5dd', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) }), index.h("sc-button", { key: '09d452ed1c0164b388098514671d145be6befeca', type: "primary", submit: true, full: true, loading: this.loading }, wp.i18n.__('Save Payment Method', 'surecart'))));
    }
