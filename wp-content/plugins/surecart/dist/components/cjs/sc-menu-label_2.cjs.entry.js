...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: '1cb6403905221fda6ca8f161f46a7e449dc4832f', part: "base", class: "menu-label" }, index.h("slot", { key: '9d1de6afb50e466179724b4bb4d36fff8f521917' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '24c29729bebf6a9af5a1aa028e88e52a0f3593c0', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: 'cf2da53412af399bd164c556bd3699d15a671589', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '4bc2f9c7a2c80b2398262cd750eaf840c04649ae', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: 'd2aca24edf1b56293edb7c37bac4f45c92300df5', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: 'e8fa3d267827fca655deffd471d4e8846ef20c34', name: "trigger", slot: "trigger" }, index.h("div", { key: 'd84a86263255b3a3b2888eb767423ddd3e460aaa', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '20f3d4caa40e7bbb26cb908c32e7b9de76bd622e', class: "select__value" }, index.h("slot", { key: 'd02af38eb17aaaf4010f312aa37e9adc54e8e8fd' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: '96a0e613223be341e52ec134681a42bac15b2db3', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: 'e4c9fbbd44cc7c5d7dc85d100bd55291d3f81e2f', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '09f9460c314d077b404cb729bcc6a6123774741b', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: '764c2f600c9e7167ada5fb7ba5d6dba2b9518273', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '3ca47830f8dbb99156b45a95812590bb7d7cd988', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: '23640f865953ffe75035b20df9aa14b369805825', class: "loading" }, index.h("sc-spinner", { key: 'dc6c8bd1c8cc846babed89b6988f588e47490796', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'bb209bc278286982bc9e6d83316c699e4b12db6b', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '56a812fe2b7742a582f1f38cdba1fd7cc06ad683', name: "suffix" }))))));
    }
