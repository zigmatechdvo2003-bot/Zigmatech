...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '426b374ef0389ab5c65d86d33313488b425bb00c', class: "cancel-discount" }, index.h("sc-dashboard-module", { key: 'ae554dd04cb027fa891b5af4e34f3fc44f3957ae', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, index.h("span", { key: '68a64885ac46ce117e52ca562b4413d7af2b6b00', slot: "description" }, description), index.h("sc-flex", { key: '9ae4a187171b63c145d241a683598e4631392c75', justifyContent: "flex-start" }, index.h("sc-button", { key: '6515700d3320f6073abb518db7682ffce9543550', type: "primary", onClick: () => this.addDiscount() }, button), index.h("sc-button", { key: '07d1b1977ba2c4fac43cfbe5d86d7ae79e0ff51f', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && index.h("sc-block-ui", { key: '8bf3c3c02be1af4faee2b7a9f0a6f6a739add009', spinner: true }))));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'e14d29c69d62db386872439fbd584633769e00ab', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, index.h("sc-form-control", { key: 'e1c6811e413365bc6879f94efb67b80cd3b4977f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'd4e1446249999debfa2f923a59e96feae368a46a', part: "form-control-input", class: "form-control-input" }, index.h("div", { key: 'df9331c9b03ec0beca7467e5525aebdcc411e9c7', part: "base", class: {
                'textarea': true,
