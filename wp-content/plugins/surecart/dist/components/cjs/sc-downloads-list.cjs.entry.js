...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: 'd58912d8bdb1082c7fc6573d8d79d923fb5084cf', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, index.h("span", { key: 'f1c5e6ac8b4cd7b8ac3fcf41f68b89a6cdbe22a4', slot: "heading" }, index.h("slot", { key: '53acfe743b074a19f6201ab25f468c4566c4e288', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), this.renderList(), index.h("sc-pagination", { key: '0da57f246127271134b730be44703289dfe47814', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.downloads) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }), this.busy && index.h("sc-block-ui", { key: '43d573db84fc6693c051b9355da265c3a8f2321f' })));
    }
