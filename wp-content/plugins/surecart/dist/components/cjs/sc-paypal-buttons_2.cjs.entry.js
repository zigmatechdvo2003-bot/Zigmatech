...
const ScPaypalButtons = class {
    ...
    render() {
        return (index.h("div", { key: 'd6f23e66b7ac788fba410e854a6152e777a33064', part: `base ${this.busy || (!this.loaded && 'base--busy')}`, class: { 'paypal-buttons': true, 'paypal-buttons--busy': this.busy || !this.loaded } }, (!this.loaded || this.busy) && index.h("sc-skeleton", { key: '7c052193ddd7953245913a0f5405798b1e028bdd', style: { 'height': '55px', '--border-radius': '4px', 'cursor': 'wait' } }), index.h("div", { key: '752920f5b0c6e5179fbffbd6b6d85315da9cdd92', class: "sc-paypal-button-container", hidden: !this.loaded || this.busy }, index.h("div", { key: '071162683cf1021ed82a51217ec7ebab3ef5f0c4', part: "paypal-card-button", hidden: !this.buttons.includes('card'), class: "sc-paypal-card-button", ref: el => (this.cardContainer = el) }), index.h("div", { key: '3ff0ee50a82f9527ce82db3e0f0ec70dbbdba8b9', part: "paypal-button", hidden: !this.buttons.includes('paypal'), class: "sc-paypal-button", ref: el => (this.paypalContainer = el) }))));
    }
...
const ScSecureNotice = class {
    ...
    render() {
        return (index.h("div", { key: '35537169f4b990458592f54b5d8ed99a4bf06223', class: "notice", part: "base" }, index.h("svg", { key: 'bebc5c7af6905d8ebf27e55ff1b49066a0d2ed04', class: "notice__icon", part: "icon", xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 512 512", fill: "currentColor" }, index.h("path", { key: 'a899f02ac1aa86a2bd845efc2953a3bf36174223', d: "M368,192H352V112a96,96,0,1,0-192,0v80H144a64.07,64.07,0,0,0-64,64V432a64.07,64.07,0,0,0,64,64H368a64.07,64.07,0,0,0,64-64V256A64.07,64.07,0,0,0,368,192Zm-48,0H192V112a64,64,0,1,1,128,0Z" })), index.h("span", { key: '272014be9bdca6b6b7cd4f0b1d376fcd481c3284', class: "notice__text", part: "text" }, index.h("slot", { key: '6bf84b6d538f2e0f90e56e094f1f11727d79f4b4', name: "prefix" }), index.h("slot", { key: '2a1a76df77ab5ebe1497e7ee331ae3f6850542f3' }), index.h("slot", { key: '56ba0c8eb2d9aad3e6de0993580a0776f3da6a2b', name: "suffix" }))));
    }
};
